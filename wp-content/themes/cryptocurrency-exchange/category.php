		...
		<div class="container text-center">
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12" data-background="">
					<h2 class="text-white"><?php esc_html_e('Category Archive : ', 'cryptocurrency-exchange') ?> <?php single_tag_title(); ?></h2>
					<p class="breadcrumb"><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e('Home', 'cryptocurrency-exchange'); ?></a> / <span><?php single_tag_title(); ?></span></p>				
				</div>			
			</div>
		</div>
	</div>
