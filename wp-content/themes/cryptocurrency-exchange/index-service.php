<section class="module" id="services">
	<div class="container">
		...
		<?php 
			...
			$cryptocurrency_exchange_service_link_1 = get_theme_mod('cryptocurrency_exchange_service_link_1', '');
			...
			$cryptocurrency_exchange_service_link_2 =  get_theme_mod('cryptocurrency_exchange_service_link_2', '');
			...
			$cryptocurrency_exchange_service_link_3 = get_theme_mod('cryptocurrency_exchange_service_link_3', ''); 
		?>
					...
					<div class="<?php echo esc_attr($cryptocurrency_exchange_service_column_layout); ?> col-sm-6 col-xs-12">
						<div class="features-item feature-box">
							...
							<h3 class="features-title font-alt">
								<?php if($cryptocurrency_exchange_service_link_1 != ""){ ?>
								<a href="<?php echo $cryptocurrency_exchange_service_link_1; ?>" target="_new">
								<?php } ?>
								
									<?php echo esc_html(stripslashes($cryptocurrency_exchange_service_title_1)); ?>
				...
				<?php if($cryptocurrency_exchange_service_icon_2 || $cryptocurrency_exchange_service_title_2 || $cryptocurrency_exchange_service_desc_2 ) { ?>
					<div class="<?php echo esc_attr($cryptocurrency_exchange_service_column_layout); ?> col-sm-6 col-xs-12">
						<div class="features-item feature-box">
							...
							<?php } ?>
							<h3 class="features-title font-alt">
								<?php if($cryptocurrency_exchange_service_link_2 != ""){ ?>
								<a href="<?php echo $cryptocurrency_exchange_service_link_2; ?>" target="_new">
								<?php } ?>
									
									<?php echo esc_html(stripslashes($cryptocurrency_exchange_service_title_2)); ?>
				...
				<?php if($cryptocurrency_exchange_service_icon_3 || $cryptocurrency_exchange_service_title_3 || $cryptocurrency_exchange_service_desc_3 ) { ?>
					<div class="<?php echo esc_attr($cryptocurrency_exchange_service_column_layout); ?> col-sm-6 col-xs-12">
						<div class="features-item feature-box">
							...
							<?php } ?>
							<h3 class="features-title font-alt">
								<?php if($cryptocurrency_exchange_service_link_3 != ""){ ?>
									<a href="<?php echo $cryptocurrency_exchange_service_link_3; ?>" target="_new">
								<?php } ?>
									
									<?php echo esc_html(stripslashes($cryptocurrency_exchange_service_title_3)); ?>
