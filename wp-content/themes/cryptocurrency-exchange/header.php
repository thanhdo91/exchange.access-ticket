			...
			<div class="row header-inner">
				...
				<div class="col-md-4">
					...
					if ( has_custom_logo() ) {
						...
						if (display_header_text() == true ) {
							$cryptocurrency_exchange_site_description = get_bloginfo( 'description', 'display' );
							echo '<h1 class="logo-text"><a href="'. esc_url(home_url( '/' )). '" class="navbar-brand">'. esc_html(get_bloginfo( 'name' )) .'</a></h1>';
							if ( $cryptocurrency_exchange_site_description || is_customize_preview() ) : ?>
									<p class="site-description"><?php echo esc_html($cryptocurrency_exchange_site_description);?></p>
							<?php endif;
						}
					}
					?>
				...
				<div class="col-md-4">
					<ul class="header-contact-info text-right">
						...
						<li>
							<span><i class="fa fa-envelope"></i><?php esc_html_e('Email : ','cryptocurrency-exchange') ?><a href="mailto:<?php echo esc_attr(get_theme_mod('cryptocurrency_email_detaill')); ?>"><?php echo esc_html(get_theme_mod('cryptocurrency_email_detaill', '')); ?></a></span>
						</li>
						<?php } ?>
					</ul>
				</div>
        ...
        <div class="container">
			<div class="navbar-header">
				<button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse">
					<span class="sr-only"><?php esc_html_e('Toggle navigation','cryptocurrency-exchange') ?></span>
